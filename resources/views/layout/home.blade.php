				...
				<div class="row mt--50">
					<div class="col-md-12 col-lg-12 col-sm-12">
						<div class="product__nav nav justify-content-center" role="tablist">
                            ...
                            <a class="nav-item nav-link" data-toggle="tab" href=".science-fiksi" role="tab">BIOGRAPHIC</a>
                            <a class="nav-item nav-link" data-toggle="tab" href="#romance" role="tab">ADVENTURE</a>
                            <a class="nav-item nav-link" data-toggle="tab" href="#mystery" role="tab">CHILDREN</a>
                            <a class="nav-item nav-link" data-toggle="tab" href="#religi" role="tab">COOK</a>
                        </div>
					</div>
				</div>
				<div class="tab__container mt--60" style="display: flex;">
					<!-- Start Single Tab Content -->
					<?php $semua =4; $i=0 ?>
				
							
								@for($i=0;$i<$semua ;$i++)
								<div class="row single__tab tab-pane fade show active {{$json->Book[$i]->category->category}}" id="nav-all" role="tabpanel" ">
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-12">
									<div class="product product__style--3">
										<div class="product__thumb">
											...
											<div class="hot__box">
												<span class="hot-label">BEST SELER</span>
											</div>
										</div>
											...
											<div class="action">
												<div class="actions_inner">
													<ul class="add_to_links">
														...
														<li><a class="wishlist" href="wishlist.html"><i class="bi bi-shopping-cart-full"></i></a></li>
														<li><a class="compare" href="#"><i class="bi bi-heart-beat"></i></a></li>
														<li><a title="Quick View" class="quickview modal-view detail-link" href="{{route('detail','id='.$json->Book[$i]->id)}}"><i class="bi bi-search"></i></a></li>
													</ul>
												</div>
											</div>
											<div class="product__hover--content">
