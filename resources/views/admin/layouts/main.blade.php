...
<head>
  ...
  <!-- Argon CSS -->
  <link type="text/css" href="{{url('/')}}/argon/assets/css/argon.css?v=1.0.0" rel="stylesheet">
  @yield('head')
</head>
...
<body>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('buku')}}">
              <i class="ni ni-planet text-blue"></i> Buku
            </a>
          </li>
        </ul>
      </div>
  ...
  <!-- Argon JS -->
  <script src="{{url('/')}}/argon/assets/js/argon.js?v=1.0.0"></script>
</body>
